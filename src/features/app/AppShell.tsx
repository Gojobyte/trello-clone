...
export function AppShell({
	...
	const { toggle: toggleSidebar } = useSidebarMode();
	...
	useEffect(() => {
		...
		const h = (e: KeyboardEvent) => {
			...
			// ⌘\ / Ctrl+\ : toggle sidebar rail/extended.
	...
	return (
		<div className="gp-app">
			...
			{/* Navigation mobile (mobile <768px uniquement) */}
			{!noSidebar && (
				<BottomNav active={active} onSearchClick={() => setCmdOpen(true)} />
			)}
